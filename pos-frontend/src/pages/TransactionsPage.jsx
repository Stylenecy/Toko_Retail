...
  // Fungsi untuk filter tanggal kustom (TETAP SAMA)
...
  // Fungsi untuk mereset SEMUA filter (TETAP SAMA)
...
            Penyesuaian Stok
          </button>
          {/* TOMBOL DATE QUICK FILTER LAINNYA DIHAPUS */}
        </div>
      </div>

      {/* FORM FILTER TANGGAL KUSTOM (TETAP ADA) */}
