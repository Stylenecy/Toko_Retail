...
            <input type="text" name="sku" value={formData.sku} onChange={handleInputChange} className="mt-1 w-full p-2 border rounded" required />
          </div>
          <div>
...
                <input type="number" name="quantityInStock" value={formData.quantityInStock} onChange={handleInputChange} className="mt-1 w-full p-2 border rounded" required />
             </div>
          </div>
...
                <textarea value={opnameData.notes} onChange={e=>setOpnameData({...opnameData, notes: e.target.value})} className="mt-1 w-full p-2 border rounded" placeholder="Alasan penyesuaian..."></textarea>
            </div>
            <div className="flex justify-end pt-4 border-t mt-6">
